...
q_sentence = u"May I borrow this book?"
a_sentence = u"Sure"
...
def create_dataset(files, num_examples):

  # Creating filtered question and answer variables
  ...
  # Looping through every other iteration in loop and filtering
  for i in range(0, len(lines), 2):

      # Indexing statement and response and checking length
      ...
      if qlen >= limit['minq'] and qlen <= limit['maxq']:
          ...
          if alen >= limit['mina'] and alen <= limit['maxa']:
              ...
              filtered_q.append(preprocess_sentence(lines[i]))

              # Appending comment to list
              filtered_a.append(preprocess_sentence(lines[i+1]))

  return filtered_q, filtered_a

# Printing data
en, sp = create_dataset(filenames, None)
